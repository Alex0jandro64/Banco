...
public interface UsuarioRepositorio extends JpaRepository<Usuario, Long> {
     ...
     * @param token de recuperación del usuario que se le estableció cuando se inició el proceso de recuperación
     ...
     * @param nombreUsuario El nombre de usuario del usuario a buscar.
     * @return El usuario buscado por su nombre de usuario.
     */
